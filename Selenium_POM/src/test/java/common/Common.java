...
public class Common extends UIElements {
    ...
    public static void clickIconOnTable(String strTableXpath, String dynamicValue, String column, String rowIndex, String icon) {
        String columnName = getColumnXpath(column);
        String newXpath = String.format("%s//tr[%s]/td[%s]//a[@title='%s']", strTableXpath, rowIndex, columnName, icon);
